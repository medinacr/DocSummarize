<script setup>
  ...
  function summarizeText() {
      if(hasText.value){
          const value = textAreaRef.value.value
          emit('response', summarizer(value))
          clearText()
      }
  }
...
<template>
     <div class="py-7 px-3 bg-white m-4 rounded-xl h-50">
            ...
            <div class="flex justify-between">
                <svg @click="summarizeText" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
